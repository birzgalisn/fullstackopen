...
const patients = patientsData.map((_a) => {
    var { id, entries } = _a, patient = __rest(_a, ["id", "entries"]);
    return (Object.assign(Object.assign({}, (0, toNewPatient_1.toNewPatient)(patient)), { entries: entries.map((_a) => {
            var { id } = _a, entry = __rest(_a, ["id"]);
            return (Object.assign(Object.assign({}, (0, toNewPatientEntry_1.toNewPatientEntry)(entry)), { id }));
        }), id }));
});
